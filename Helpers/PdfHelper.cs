...
namespace AppPdfGenAccountStatus.Helpers
{
	public class PdfHelper
	{
		...
		public void CreatePdf(string filePath, DataInputModel data)
		{
			...
			gfx.DrawString("Quetzales", fontRegularMin, XBrushes.White, new XRect(startX + 380.0, startY + 5.0, boxWidth, 10.0), XStringFormats.TopLeft);
			gfx.DrawString("Dolares", fontRegularMin, XBrushes.White, new XRect(startX + 440.0, startY + 5.0, boxWidth, 10.0), XStringFormats.TopLeft);
			DrawContentGetOutCash(startX, ref currentY, ref availableHeight, ref document, ref page, ref gfx, fontRegularMin, 12.0, 0, marginBottom, ref listgfx);
		...
		private void DrawLabelBox(XGraphics gfx, double x, double y, double width, double height, bool fillColor)
		{
		...
		private void DrawFooter(XGraphics gfx, XFont font, PdfDocument document, ref List<XGraphics> listgfx)
		{
		...
		private void DrawContent(double startX, ref double startY, ref double availableHeight, ref PdfDocument document, ref PdfPage page, ref XGraphics gfx, XFont font, double SpaceBetweenLine, int Numblines, double marginBottom, ref List<XGraphics> listgfx)
		{
		...
		private void DrawContentMain(double startX, ref double startY, ref double availableHeight, ref PdfDocument document, ref PdfPage page, ref XGraphics gfx, XFont font, double SpaceBetweenLine, VtcObtenerMovimientosCuentaMesResponse vtcObtenerMovimientosCuentaMes, double marginBottom, ref List<XGraphics> listgfx)
		{
		...
		private void DrawContentVisaCuotas(double startX, ref double startY, ref double availableHeight, ref PdfDocument document, ref PdfPage page, ref XGraphics gfx, XFont font, double SpaceBetweenLine, VtcObtenerMovimientosCuentaMesResponse vtcObtenerMovimientosCuentaMes, double marginBottom, ref List<XGraphics> listgfx)
		{
		...
		private void DrawContentPayConvent(double startX, ref double startY, ref double availableHeight, ref PdfDocument document, ref PdfPage page, ref XGraphics gfx, XFont font, double SpaceBetweenLine, int Numblines, double marginBottom, ref List<XGraphics> listgfx)
		{
			double currentY = startY;
			for (int i = 0; i < Numblines; i++)
			{
		...
		private void DrawContentGetOutCash(double startX, ref double startY, ref double availableHeight, ref PdfDocument document, ref PdfPage page, ref XGraphics gfx, XFont font, double SpaceBetweenLine, int Numblines, double marginBottom, ref List<XGraphics> listgfx)
		{
			double currentY = startY;
			for (int i = 0; i < Numblines; i++)
			{
				...
				gfx.DrawString("22/06/2024", font, XBrushes.Black, new XRect(startX + 11.0, currentY + 5.0, 30.0, 10.0), XStringFormats.TopLeft);
				gfx.DrawString("21/06/2024", font, XBrushes.Black, new XRect(startX + 70.0, currentY + 5.0, 30.0, 10.0), XStringFormats.TopLeft);
				gfx.DrawString("TRE FRATELLI GUATEMALA GT", font, XBrushes.Black, new XRect(startX + 130.0, currentY + 5.0, 30.0, 10.0), XStringFormats.TopLeft);
				gfx.DrawString("179.00", font, XBrushes.Black, new XRect(startX + 380.0, currentY + 5.0, 30.0, 10.0), XStringFormats.TopRight);
				gfx.DrawString("0.00", font, XBrushes.Black, new XRect(startX + 430.0, currentY + 5.0, 30.0, 10.0), XStringFormats.TopRight);
				DrawingVerticalLine(gfx, startX, currentY, SpaceBetweenLine, 1.0);
				DrawingVerticalLine(gfx, startX + 490.0, currentY, SpaceBetweenLine, 1.0);
				currentY += SpaceBetweenLine;
		...
		private void DrawingVerticalLine(XGraphics gfx, double startX, double startY, double length, double thickness)
		{
			XPen pen = new XPen(XColor.FromArgb(0, 14, 119, 187), thickness);
			gfx.DrawLine(pen, startX, startY, startX, startY + length);
		}

		private void DrawingHorizontalLine(XGraphics gfx, double startX, double startY, double length, double thickness)
		{
			XPen pen = new XPen(XColor.FromArgb(0, 14, 119, 187), thickness);
