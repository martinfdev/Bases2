...
import { getSpecialties, registerUser } from '../../services/developerService'
import NewUserForm from '../../components/forms/NewUserForm'
import Waiting from '../../components/shared/Waiting'
import useAppContext from '../../hooks/useAppContext'

const NewUserRegisterDevPage = ({ currentUserRole }) => {
...
NewUserRegisterDevPage.propTypes = {
    currentUserRole: PropsTypes.number.isRequired
}

export default NewUserRegisterDevPage