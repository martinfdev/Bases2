...
export async function registerUser(userData) {
    try {
        //   const response = await fetch(`${API_URL}/desarrollador/register`, {
        //     method: 'POST',
        //     headers: {
        //        Authorization: `Bearer ${localStorage.getItem('token')}`,
        //       'Content-Type': 'application/json',
...
export const getSpecialties = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/obtener_especialidades`, {
        //     method: 'GET', 
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const createSpecialty = async (specialtyData) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/insertar_especialidad`, {
        //     method: 'POST',
        //     headers: {
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
        //         'Content-Type': 'application/json',
...
export const getUsers = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/lista_usuarios`, {
        //     method: 'GET', 
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const getUser = async (userId) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/consulta_usuario`, {
        //     method: 'GET', 
        //     headers: {
        //         'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const deleteUser = async (userId) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/eliminacion_usuario`, {
        //     method: 'DELETE', 
        //     headers: {
        //         'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
        ...
        console.log('userData to send:', userId)
        return data
    } catch (error) {
...
export const updateUser = async (userData) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/actualizar_usuario`, {
        //     method: 'PUT',
        //     headers: {
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
        //         'Content-Type': 'application/json',
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/crear_paciente`, {
//         //     method: 'POST',
//         //     headers: {
//         //         Authorization: `Bearer ${localStorage.getItem('token')}`,
//         //         'Content-Type': 'application/json',
...
export const deletePatient = async (patientId) => {
    try {
        ...
        // const response = await fetch(`${API_URL}/desarrollador/eliminar_paciente`, {
        //     method: 'DELETE',
        //     headers: {
        //         'Content-Type': 'application/json',
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const updatePatient = async (patientData) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/editar_paciente`, {
        //     method: 'PUT',
        //     headers: {
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
        //         'Content-Type': 'application/json',
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/consulta_paciente`, {
//         //     method: 'GET',
//         //     headers: {
//         //          'Content-Type': 'application/json', 
//         //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const createArea = async (areaData) => { 
    try {
        // const response = await fetch(`${API_URL}/desarrollador/editar_area`, {
        //     method: 'POST',
        //     headers: {
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
        //         'Content-Type': 'application/json',
...
export const getAreas = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/lista_area`, {
        //     method: 'GET',
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const deleteArea = async (nombreArea) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/eliminar_area`, {
        //     method: 'DELETE',
        //     headers: {
        //         'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const updateArea = async (areaData) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/actualizar_area`, {
        //     method: 'PUT',
        //     headers: {
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
        //         'Content-Type': 'application/json',
...
export const getArea = async (areaName) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/consultar_area`, {
        //     method: 'GET',
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const getAttendedPatients = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/pacientes_atendidos`, {
        //     method: 'GET',
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/obtener-diagnosticos-comunes`, {
//         //     method: 'GET',
//         //     headers: {
//         //          'Content-Type': 'application/json', 
//         //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const getPatientsDontHaveArea = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/paciente_sin_area`, {
        //     method: 'GET',
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/descargarPDF_area`, {
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/descargar_reporte_pacientes`, {
//         const response = await fetch(`https://run.mocky.io/v3/2cc4f894-9b5d-4c74-8de0-5c228f71e928`, {
//             method: 'GET',
//             headers: {
//                 Authorization: `Bearer ${localStorage.getItem('token')}`,
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/descargar_reporte_diagnosticos`, {
//         const response = await fetch(`https://run.mocky.io/v3/2cc4f894-9b5d-4c74-8de0-5c228f71e928`, {
//             method: 'GET',
//             headers: {
//                 Authorization: `Bearer ${localStorage.getItem('token')}`,
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/downloadReportAreaExcel`, {
//         const response = await fetch(`https://run.mocky.io/v3/2cc4f894-9b5d-4c74-8de0-5c228f71e928`, {
//             method: 'GET',
//             headers: {
//                 Authorization: `Bearer ${localStorage.getItem('token')}`,
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/descargar_reporte_pacientes_excel`, {
//         const response = await fetch(`https://run.mocky.io/v3/2cc4f894-9b5d-4c74-8de0-5c228f71e928`, {
//             method: 'GET',
//             headers: {
//                 Authorization: `Bearer ${localStorage.getItem('token')}`,
...
//     try {
//         // const response = await fetch(`${API_URL}/desarrollador/descargar_reporte_diagnosticos_excel`, {
//         const response = await fetch(`https://run.mocky.io/v3/2cc4f894-9b5d-4c74-8de0-5c228f71e928`, {
//             method: 'GET',
//             headers: {
//                 Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const getNurses = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/enfermeras`, {
        //     method: 'GET',
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const getDoctors = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/doctores`, {
        //     method: 'GET',
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
...
export const assignPatient = async (dataToSend) => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/agregar_paciente_area`, {
        //     method: 'POST',
        //     headers: {
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
        //         'Content-Type': 'application/json',
...
export const getPatientsLastIngresed = async () => {
    try {
        // const response = await fetch(`${API_URL}/desarrollador/ultimos_pacientes_ingresados`, {
        //     method: 'GET',
        //     headers: {
        //          'Content-Type': 'application/json', 
        //         Authorization: `Bearer ${localStorage.getItem('token')}`,
