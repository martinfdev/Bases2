...
def actualizar_usuario(current_user):
    ...
    try:
        ...
        if not especialidad_exist:
            save_log_param("update", "ERROR", "actualizar_usuario", "Desarrollador_Controller", "La especialidad no existe")
...
def consulta_paciente(current_user):
    ...
    try:
        ...
        cursor.close()
        conn.close()
        #save_log_param("consulta", "INFO", "consulta_paciente", "Desarrollador_Controller", "Exito, Area Eliminada Correctamente")
